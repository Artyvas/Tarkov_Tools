...
Map.create!({ name: "Customs", description: "Medium range map that has been described as the 'Dust 2' of Tarkov Maps" })

Location.create!({ map_id: 1, location_code: "" })
Location.create!({ map_id: 1, location_code: "" })
Location.create!({ map_id: 1, location_code: "" })
Location.create!({ map_id: 1, location_code: "" })
Location.create!({ map_id: 1, location_code: "" })
...
Key.create!({ location_id: 1, name: "N/A", market_price: 0, trader_price: 0, trader: "N/A", searchable_object_id: 1, image_url: "N/A" })
Key.create!({ location_id: 1, name: "N/A", market_price: 0, trader_price: 0, trader: "N/A", searchable_object_id: 1, image_url: "N/A" })
Key.create!({ location_id: 1, name: "N/A", market_price: 0, trader_price: 0, trader: "N/A", searchable_object_id: 1, image_url: "N/A" })
Key.create!({ location_id: 1, name: "N/A", market_price: 0, trader_price: 0, trader: "N/A", searchable_object_id: 1, image_url: "N/A" })
Key.create!({ location_id: 1, name: "N/A", market_price: 0, trader_price: 0, trader: "N/A", searchable_object_id: 1, image_url: "N/A" })
...
LootRoom.create!({ location_id: 1, name: "", description: "", key_id: 1, wiki_url: "", image_id: 1 })
LootRoom.create!({ location_id: 1, name: "", description: "", key_id: 1, wiki_url: "", image_id: 1 })
LootRoom.create!({ location_id: 1, name: "", description: "", key_id: 1, wiki_url: "", image_id: 1 })
LootRoom.create!({ location_id: 1, name: "", description: "", key_id: 1, wiki_url: "", image_id: 1 })
LootRoom.create!({ location_id: 1, name: "", description: "", key_id: 1, wiki_url: "", image_id: 1 })
